...
class App extends Component {
  ...
  initMap() {
    ...
    var map = new window.google.maps.Map(mapview, {
      center: { lat: -22.411644, lng: -50.576556 },
      zoom: 15,
  ...
  getMarkerInfo(marker) {
    ...
    var clientId = "ZIIWJEIMV5SBFM5NS4JJ3LDWT0CZWDELS0YG5ESRV3LQGRBB";
    var clientSecret = "UG1NIZ32GHVA0II4OIQYUAOL0EXDNHCQ4Y0INBYYNBRLDDDN";
